          ...
          {isCryptomus ? (
            <div className="rounded-2xl border border-white/[0.06] bg-gradient-to-br from-primary/[0.08] to-white/[0.02] p-5 space-y-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="cm-usd" className="text-xs uppercase tracking-wider text-muted-foreground">Amount (USD)</Label>
                ...
                <div className="flex gap-1.5 pt-1 flex-wrap">
                  {[5, 10, 20, 50, 100].map(v => (
                    <button key={v} type="button" onClick={() => setAmount(String(v))} className="text-[11px] px-2.5 py-1 rounded-full border border-white/[0.08] bg-white/[0.03] hover:bg-primary/10 hover:border-primary/30 hover:text-primary transition-colors">
                      ${v}
                    </button>
                  ))}
                </div>
