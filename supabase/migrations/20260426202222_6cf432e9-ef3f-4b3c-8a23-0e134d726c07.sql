...
RETURNS TABLE(order_id uuid, product_id uuid, product_name text, quantity integer, unit_cost numeric, total_cost numeric, balance_after numeric, details jsonb)
LANGUAGE plpgsql
SECURITY DEFINER
